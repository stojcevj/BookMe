...
public interface PropertyService {
    ...
    Page<PropertyResponse> findAll(Pageable pageable, String search, LocalDateTime startDate, LocalDateTime endDate, Authentication authentication);
    ...
    Page<PropertyResponse> findAllFavouritesForUser(Authentication authentication, Pageable pageable);
